         ...
         <div class="row">
            ...
            <div class="col-2">
               <div id="ppx_head-badge">
                  <p style="font-weight:bold;">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; Edit Appointment</p>
               </div>
               ...
               <div id="ppx_LayoutGrid1">
                  <form name="Edit_Appt" method="post" action="update-appt.php" enctype="multipart/form-data" target="_blank" id="LayoutGrid1">
                     <div class="row">
                        <div class="col-1">
                           ...
                           <div id="ppx_ipf_appt-title" style="display:inline-block;width:100%;height:40px;z-index:41;">
                              <input type="text" id="ipf_appt-title"  name="appt_title" value="" maxlength="10" autocomplete="off" spellcheck="false" placeholder="Enter a Project Name (Max 50)">
                           ...
                           <div id="ppx_ipf_appt-desc" style="display:inline-block;width:100%;height:200px;z-index:44;">
                              <textarea name="appt_desc" id="ipf_appt-desc"  rows="9" cols="111" maxlength="255" autocomplete="off" spellcheck="false" placeholder="Enter Project Description (255 letter)"></textarea>
                           ...
                           <input type="submit" id="btn-change" name="" value="Change" style="display:inline-block;width:168px;height:44px;z-index:49;">
                        </div>
                     </div>
                  </form>
               </div>
