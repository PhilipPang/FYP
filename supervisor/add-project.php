...
$query = "SELECT supervisor_id, supervisor_firstname, supervisor_lastname, supervisor_profilepic FROM supervisor LIMIT 1";
      ...
      <nav id="LayoutGrid2">
         <div class="row">
            ...
            <div class="col-2">
               ...
               <hr id="HorizontalLine8" style="display:block;width:100%;z-index:66;">
               <div id="ppx_back-btn" style="display:inline-block;width:120px;height:50px;z-index:67;">
               ...
               <hr id="HorizontalLine9" style="display:block;width:100%;z-index:68;">
               <div id="ppx_LayoutGrid1">
                  <form name="Add_project" method="post" action="project-submit.php" enctype="multipart/form-data" target="_blank" id="LayoutGrid1">
                     <div class="row">
                        <div class="col-1">
                           <label class="Lable-status" for="ipf_project_name" id="lbl_project_name" style="display:block;width:100%;line-height:18px;z-index:45;">Project Name</label>
                           <div id="ppx_ipf_project_name" style="display:inline-block;width:100%;height:40px;z-index:46;">
                              <input type="text" id="ipf_project_name"  name="project_name" value="" maxlength="50" autocomplete="off" spellcheck="false" placeholder="Enter a Project Name (Max 50)">
                           ...
                           <label class="Lable-status" for="ipf_desc" id="lbl_desc" style="display:block;width:100%;line-height:18px;z-index:48;">Description</label>
                           <div id="ppx_ipf_desc" style="display:inline-block;width:100%;height:200px;z-index:49;">
                           ...
                           <hr id="HorizontalLine10" style="display:block;width:100%;z-index:50;">
                           <div id="ppx_Text4">
                              <span style="color:#7F63F4;font-family:Arial;font-size:16px;"><strong>Project Guideline</strong></span>
                           </div>
                           <hr id="HorizontalLine11" style="display:block;width:100%;z-index:52;">
                           <label class="Lable-status" for="ipf_guide_title" id="lbl_guide_title" style="display:block;width:100%;line-height:18px;z-index:53;">Title</label>
                           <div id="ppx_ipf_guide_title" style="display:inline-block;width:100%;height:40px;z-index:54;">
                           ...
                           <hr id="HorizontalLine12" style="display:block;width:100%;z-index:55;">
                           <label class="Lable-status" for="ipf_overview" id="lbl_overview" style="display:block;width:100%;line-height:18px;z-index:56;">Project Overview</label>
                           <div id="ppx_ipf_overview" style="display:inline-block;width:100%;height:200px;z-index:57;">
                              <textarea name="guideline_overview" id="ipf_overview"  rows="9" cols="111" autocomplete="off" spellcheck="false" placeholder="Enter Project Overview"></textarea>
                              <div class="invalid-feedback">Please Enter Project Overview</div>
                           </div>
                           <hr id="HorizontalLine13" style="display:block;width:100%;z-index:58;">
                           <label class="Lable-status" for="ipf_instruction" id="lbl_instruction" style="display:block;width:100%;line-height:18px;z-index:59;">Project Instruction/requirement</label>
                           <div id="ppx_ipf_instruction" style="display:inline-block;width:100%;height:200px;z-index:60;">
                              <textarea name="guideline_desc" id="ipf_instruction"  rows="9" cols="111" autocomplete="off" spellcheck="false" placeholder="Enter Project Instruction/requirement"></textarea>
                              <div class="invalid-feedback">Please Enter The Description.</div>
                           </div>
                           <hr id="HorizontalLine14" style="display:block;width:100%;z-index:61;">
                           <div id="ppx_ipf_guide_file" style="display:inline-block;width:100%;z-index:62;">
                              <div id="ipf_guide_file" class="input-group">
                                 ...
                                 <label class="input-group-btn">
                                    <input type="file" accept=".doc,.docx,.pdf" name="guideline_file" id="ipf_guide_file-file" style="display:none;"><span class="btn">Browse...</span>
                                 </label>
                              </div>
                           </div>
                           <hr id="HorizontalLine15" style="display:block;width:100%;z-index:63;">
                           <input type="submit" id="btn-submit" name="" value="Submit" style="display:inline-block;width:168px;height:44px;z-index:64;">
                        </div>
                     </div>
                  </form>
               </div>
