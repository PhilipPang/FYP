...
// $sql = "SELECT * FROM notification LIMIT 2";
...
//     $row = mysqli_fetch_assoc($result);
//     $id1 = $row["notification_ID"];
//     $student1 = $row["student_ID"];
//     $supervisor1 = $row["supervisor_ID"];
//     $admin1 = $row["admin_ID"];
//     $title1 = $row["notification_title"];
//     $message1 = $row["notification_message"];
//     $create1 = $row["created_at"];
//     $read1 = $row["is_read"];
      ...
      <nav id="content">
         <div class="row">
            ...
            <div class="col-2">
               ...
               <hr id="HorizontalLine8" style="display:block;width:100%;z-index:48;">
               ...
               <?php
				function display_notification($notification_row, $student_row){
			   ?>
			   ...
			   ?>
			   <?php
				$notification_SQL = "SELECT * FROM notification WHERE supervisor_ID=".$supervisor_ID;
				...
				foreach ($rows as $row) {
					$student_SQL = "SELECT * FROM student WHERE student_ID=".$row[1];
					$student_result = mysqli_query($conn, $student_SQL);
					$student_row = mysqli_fetch_array($student_result);
					display_notification($row, $student_row);
				}
			   ?>
